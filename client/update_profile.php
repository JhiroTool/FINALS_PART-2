...
$client_stmt = $conn->prepare('SELECT Client_FN, Client_LN, Client_Email, Client_Phone FROM client WHERE Client_ID = ? LIMIT 1');
...
<head>
    ...
    <title>Profile Settings - PinoyFix</title>
            ...
            <section class="insights-section" style="margin-top: 2rem;">
                ...
                <div class="insights-grid">
                    <div class="insight-card">
                        <h4>Name</h4>
                        <p><?php echo htmlspecialchars($client['Client_FN'] . ' ' . $client['Client_LN']); ?></p>
                    </div>
                    ...
                    <div class="insight-card feedback">
                        <h4>Phone</h4>
                        <p><?php echo htmlspecialchars($client['Client_Phone'] ?: 'Not set'); ?></p>
                    </div>
                </div>
                <p style="margin-top: 1.5rem; color: #64748b;">Profile editing tools are coming soon. Reach out to support if you need immediate updates.</p>
            </section>
        </div>
    </main>
</body>
